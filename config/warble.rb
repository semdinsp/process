...
Warbler::Config.new do |config|
  ...
  # original config.pathmaps.public_html = ["%{public/,}p"]
   config.pathmaps.public_html = ["%p"]
  ...
  # (Goldspike-specific; see README for details)
   config.webxml.pool.maxActive = 6
   config.webxml.rails_root = 'WEB-INF'
   config.webxml.files_prefix = "public/"

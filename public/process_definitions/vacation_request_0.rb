...
class VacationRequest0 < OpenWFE::ProcessDefinition
    ...
    #
    # setting some fields right at the beginning of the process
    #
    ...
    sequence do
        ...
        #
        # the first participant is the employee (the user who launched
        # the process)
        #
        employee
        
        #
        # now setting some fields that the assistant and perhpas the
        # boss will fill.
        #
        ...
        #
        # if the assistanct set the field 'boss_should_have_a_look', then
        # the process will head to the boss desk
        #
